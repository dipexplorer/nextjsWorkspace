      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-lg transform transition-all duration-500 hover:shadow-xl">
        ...
        {isLoading ? (
          ...
          <div className="text-center space-y-6">
            <div className="text-green-500 text-lg font-medium">Email Verified Successfully!</div>
            <p className="text-gray-600">Your account has been verified. You can now log in and use all features.</p>
            <Link
              href="/login"
          ...
          <div className="text-center space-y-6">
            <div className="text-red-500 font-medium">{error || "Verification failed"}</div>
            
            <div className="bg-gray-50 p-4 rounded-lg text-left text-sm text-gray-600">
              <p className="mb-2">The verification link may have expired or is invalid.</p>
